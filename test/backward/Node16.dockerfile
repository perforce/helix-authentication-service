FROM node:16-slim
#
# Run unit tests on Node.js v16 for verification of backward compatibility. This
...
#
# $ docker build -t has-test-node16 -f test/backward/Node16.dockerfile .
# $ docker image ls | grep has-test-node16
#
