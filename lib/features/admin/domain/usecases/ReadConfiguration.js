...
// names of settings whose values are always stored in files
const onlyFileSettings = {
...
export default ({
  ...
  return async () => {
    ...
    const fileSettings = Object.entries(onlyFileSettings).concat(Object.entries(maybeFileSettings))
