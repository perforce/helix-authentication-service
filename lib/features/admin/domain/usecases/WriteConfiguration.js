 ...
 */
export default ({ configRepository, defaultsRepository, convertToProviders, formatAuthProviders }) => {
  ...
  assert.ok(convertToProviders, 'convertToProviders must be defined')
  ...
  return async (incoming) => {
    ...
    await convertToProviders(settings)
