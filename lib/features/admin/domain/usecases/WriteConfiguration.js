 ...
 */
export default ({ configRepository, convertFromProviders }) => {
...
// format the AUTH_PROVIDERS value as a JSON string so it can be safely written
// to the configuration file
function formatAuthProviders(settings) {
  if (settings.has('AUTH_PROVIDERS')) {
    const content = settings.get('AUTH_PROVIDERS')
    const formatted = { providers: content }
