...
function loadSamlOptions () {
  ...
  const samlOptions = {
    ...
    authnContext,
    wantAssertionsSigned: getTruthySetting('SAML_WANT_ASSERTION_SIGNED'),
    wantAuthnResponseSigned: getTruthySetting('SAML_WANT_RESPONSE_SIGNED'),
...
function getTruthySetting (name) {
