...
async function buildOptionsFromProvider(provider, getSamlAuthnContext) {
  ...
  if ('wantAssertionsSigned' in provider) {
    configured.wantAssertionsSigned = assessTruth(provider.wantAssertionsSigned)
  } else {
    configured.wantAssertionsSigned = false
  }
  if ('wantAuthnResponseSigned' in provider) {
    configured.wantAuthnResponseSigned = assessTruth(provider.wantAuthnResponseSigned)
  } else {
