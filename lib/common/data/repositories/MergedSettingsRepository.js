...
// and defaults repositories. All writes are passed through to the process.env
// repository, while reads go to the temporary first, then process.env, and
// finally the defaults repository.
//
