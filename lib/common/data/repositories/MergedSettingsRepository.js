...
class MergedSettingsRepository extends SettingsRepository {
  ...
  get(name) {
    ...
    if (this._dotenv.has(name)) {
      return this._dotenv.get(name)
    }
  ...
  getBool(name) {
    ...
    if (this._dotenv.has(name)) {
      return this._dotenv.getBool(name)
    }
  ...
  has(name) {
    ...
    return this._temporary.has(name) || this._dotenv.has(name) || this._defaults.has(name)
  }
