...
const usersRouter = include('lib/features/scim/presentation/routes/users')
const groupsRouter = include('lib/features/scim/presentation/routes/groups')
...
const redisUrl = settings.get('REDIS_URL')
if (redisUrl) {
