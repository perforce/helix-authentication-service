...
const oidcRouter = include('lib/presentation/routes/oidc')
const requestsRouter = include('lib/presentation/routes/requests')
const samlRouter = include('lib/presentation/routes/saml')
...
app.set('views', [
  ...
  path.join(__dirname, 'presentation', 'pages')
])
