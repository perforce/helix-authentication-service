...
/* global include */
const ReceiveUserProfile = include('lib/domain/usecases/ReceiveUserProfile')
...
if (process.env.REDIS_URL) {
  ...
  RequestRepository = include('lib/data/repositories/RedisRequestRepository')
  UserRepository = include('lib/data/repositories/RedisUserRepository')
} else {
  logger.debug('container: registering in-memory repositories')
  RequestRepository = include('lib/data/repositories/InMemoryRequestRepository')
  UserRepository = include('lib/data/repositories/InMemoryUserRepository')
}
