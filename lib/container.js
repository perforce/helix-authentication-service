...
container.register({
  ...
  // concurrent locking support for SCIM use cases
  entityRepositoryLock: asClass(ReadWriteLock, { lifetime: Lifetime.SINGLETON }),
  ...
  generateFormAction: asFunction(GenerateFormAction),
